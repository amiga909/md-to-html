...
/**
 * Mume's offline export can leave some stylesheets (e.g. KaTeX) as absolute
 * file:// links into the local node_modules instead of inlining them. Read
 * those files and embed their contents directly so the HTML has no
 * dependency on the machine/project it was generated on.
 */
